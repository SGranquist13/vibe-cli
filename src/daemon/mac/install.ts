/**
 * Installation script for Vibe daemon using macOS LaunchDaemons
 * 
 * NOTE: This installation method is currently NOT USED in favor of auto-starting 
 * the daemon when the user runs the vibe command. 
 * 
 ...
 * 2. We assume users will run vibe frequently (every time they open their laptop)
...
const PLIST_LABEL = 'com.vibe-cli.daemon';
...
export async function install(): Promise<void> {
    try {
        ...
        // Get the path to the vibe CLI executable
        const vibePath = process.argv[0]; // Node.js executable
        ...
        const plistContent = trimIdent(`
            ...
            <dict>
                ...
                <array>
                    ...
                    <string>vibe-daemon</string>
                </array>
                
                <key>EnvironmentVariables</key>
                <dict>
                    <key>VIBE_DAEMON_MODE</key>
                    <string>true</string>
                </dict>
                ...
                <string>${os.homedir()}/.vibe/daemon.err</string>
                
                <key>StandardOutPath</key>
                <string>${os.homedir()}/.vibe/daemon.log</string>
        ...
        logger.info('Check logs at ~/.vibe/daemon.log');
