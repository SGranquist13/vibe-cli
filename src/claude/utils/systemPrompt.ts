...
const CO_AUTHORED_CREDITS = (() => trimIdent(`
    When making commit messages, instead of just giving co-credit to Claude, also give credit to vibe like so:

    <main commit message>

    Generated with [Claude Code](https://claude.ai/code)
    via [vibe](https://github.com/your-username/vibe-on-the-go)

    Co-Authored-By: Claude <noreply@anthropic.com>
    Co-Authored-By: vibe <noreply@vibeonthego.com>
`))();
